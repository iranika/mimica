...
interface AegiSetting{
    dotRate: number,
    hash: string
}

const DAegiSetting = <AegiSetting>{
    dotRate: 0.3
};
...
export class Aegi {
    ...
    public get OrignText(){
        return this._OrignText;
    }
    public get AegiText(){
        return this._AegiText;
    }
    ...
    public genAegiText(t :string = this._OrignText, setting: AegiSetting = DAegiSetting): string{
        this._AegiText = this
                            .insertText("っ", 0.3)
                            .insertText("♡")
                            .insertText("…")
